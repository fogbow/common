 ...
 */
public class CreateAuthenticationRequest implements JsonSerializable {
    ...
    public CreateAuthenticationRequest(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        CreateAuthenticationRequest request = (CreateAuthenticationRequest) o;
