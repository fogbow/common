package cloud.fogbow.common.requests.api.local.http;

import cloud.fogbow.common.api.http.Image;
import cloud.fogbow.common.core.ApplicationFacade;
...
public class ImageTest {
    ...
    public void testGetImageById() throws Exception {
        ...
        cloud.fogbow.common.core.models.images.Image image = new cloud.fogbow.common.core.models.images.Image(fakeId, "fake-name", 1, 1, 1, "READY");
        ...
        cloud.fogbow.common.core.models.images.Image resultImage = new Gson().fromJson(result.getResponse().getContentAsString(), cloud.fogbow.common.core.models.images.Image.class);
