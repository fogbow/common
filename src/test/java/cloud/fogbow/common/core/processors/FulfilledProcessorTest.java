package cloud.fogbow.common.core.processors;
...
import cloud.fogbow.common.core.constants.DefaultConfigurationConstants;
...
public class FulfilledProcessorTest extends BaseUnitTests {
    ...
    private Order createOrder() {
        FederationUser federationUser = new FederationUser("fake-token-provider", "token-value", "login", "user");
