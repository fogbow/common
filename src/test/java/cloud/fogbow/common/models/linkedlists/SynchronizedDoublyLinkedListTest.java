...
public class SynchronizedDoublyLinkedListTest {
    ...
    @Test
    public void testAddFirst() throws InternalServerErrorException {
        // verify
    ...
    @Test
    public void testAddOrder() throws InternalServerErrorException {
        // verify
        Assert.assertNull(this.integerList.getHead());
    ...
    // test case: Adding a null element to the list should throw an InternalServerErrorException.
    @Test
    ...
    @Test
    public void testResetPointer() throws InternalServerErrorException {
        // verify
        Assert.assertNull(this.integerList.getHead());
    ...
    // test case: Removing a null item should throw an InternalServerErrorException.
    @Test
    ...
    // return that element.
    @Test
    public void testFindNodeToRemove() throws InternalServerErrorException {
        // verify
        Assert.assertNull(this.integerList.getHead());
    ...
    @Test
    public void testRemoveItemOnHead() throws InternalServerErrorException {
        // verify
        Assert.assertNull(this.integerList.getHead());
    ...
    @Test
    public void testRemoveItemOnTail() throws InternalServerErrorException {
        // verify
        Assert.assertNull(this.integerList.getHead());
    ...
    @Test
    public void testRemoveItemOneElementOnList() throws InternalServerErrorException {
        // verify
        Assert.assertNull(this.integerList.getHead());
    ...
    @Test
    public void testReinitializingList() throws InternalServerErrorException {
        // verify
        Assert.assertNull(this.integerList.getHead());
